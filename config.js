...
**שני מצבי שימוש:**
• **מצב מהיר** (ברירת מחדל) — 3 שלבים: בחר אזור ← בחר תחומים ← קבל תוצאות
• **מצב מתקדם** — שליטה מלאה: הוסף מקומות, ערוך, שמור מסלולים

**3 צעדים פשוטים:**
1. **בחר איזור** (או "הכל" לכל בנגקוק, או GPS לקרוב אליך)
2. **בחר מה מעניין אותך** — מקדשים, אוכל, גרפיטי...
3. **לחץ "מצא נקודות עניין"**

**בתוצאות:**
• ⏸️ דלג על מקום  •  ▶️ החזר מקום
• 📌 קבע נקודת התחלה  •  🧭 חשב מסלול

**טיפ:** לחץ על שם מקום כדי לפתוח בגוגל מפות!`
  },
  placesListing: {
    title: 'רשימת המקומות',
