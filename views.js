  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-rose-50" dir="rtl">
      {/* Loading Overlay */}
      {!isDataLoaded && (
        <div className="fixed inset-0 bg-gradient-to-br from-amber-50 to-rose-50 z-[100] flex flex-col items-center justify-center">
                      ...
                      <div className="flex gap-1 items-center">
                        <div className="flex-1 relative">
                          <input
                            ...
                            style={{ direction: 'rtl', paddingLeft: '8px', paddingRight: '8px' }}
                          />
                        </div>
